...
| [legal-privacy-policy](docs/legal/隐私协议.md) | `9d6c193fc` 中 / `86f98ea1b` 英 | 用户隐私协议中英两版 v0.4 草稿(笑南个人开源 / MIT / 中华人民共和国法律 / 中英冲突以中文为准 / 决策不单独发布 EULA);未来版本会加使用统计 + 更新检查通道,均 opt-out | Tiny,纯文档,无 code,**非 feature**(放 `docs/legal/`,中英分两笔 commit 规避 500 行阈值,无 override) |
