                    ...
                    {(_id) => (
                      ...
                      <div class="contents" onClick={handleChatMdLinkClick}>
                        <MessageTimeline
                          ...
                          // FORK: REQ-097 会话内查找 — 历史桥接 timeline model;loadMore 用裸 loadOlder()
                          //   (不带 capture/restore 视口锚定 — 查找的后台深挖不该钉住视口,
                          //   钉住会把底部锚成死点、reveal 跳转每帧被回拽)[feat: in-session-find] 2026-08-11
                          findHistory={{
                            more: historyMore,
