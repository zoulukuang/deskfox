export const dict = {
  ...
  "palette.group.sessionContent": "セッション内容",
  "palette.sessionContent.searchAllProjects": "すべてのプロジェクトで検索",
  "palette.sessionContent.searchCurrentProject": "現在のプロジェクトのみ検索",
  ...
  "home.welcome.title": "あなた専用の AI アシスタントの準備が整いました",
  "home.welcome.description": "ローカルのプロジェクトフォルダを Fox に渡せば、プロジェクト構造を深く理解し、いつでもあなたをサポートします",
  "home.welcome.open": "フォルダを開く",
  ...
  "common.undo": "元に戻す",
  "find.placeholder": "セッション内を検索",
  "find.prev": "前へ",
  "find.next": "次へ",
  "session.archive.toast.title": "アーカイブしました",
  "session.archive.toast.description": "検索から見つけて復元できます",
  "common.delete": "削除",
  "common.close": "閉じる",
  "common.edit": "編集",
