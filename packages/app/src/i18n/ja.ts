export const dict = {
  ...
  "home.empty.title": "あなた専用の AI ワークアシスタントの準備が整いました",
  "home.empty.description": "ローカルのプロジェクトフォルダを Fox に渡せば、プロジェクト構造を深く理解し、いつでもあなたをサポートします",
  "home.empty.open": "プロジェクトフォルダを開く",
