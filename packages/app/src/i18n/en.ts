export const dict = {
  ...
  "palette.group.sessionContent": "Session content",
  "palette.sessionContent.searchAllProjects": "Search in all projects",
  "palette.sessionContent.searchCurrentProject": "Search this project only",
  ...
  "session.archive.toast.title": "Session archived",
  "session.archive.toast.description": "Find it via search to restore",
  ...
  "fileTree.menu.copyRelativePath": "Copy Relative Path",
  "fileTree.menu.openInTerminal": "Open in Terminal",
  "fileTree.menu.expandAll": "Expand All",
  "fileTree.menu.collapseAll": "Collapse All",
  ...
  "fileTree.toast.createFailed": "Failed to create",
  "fileTree.toast.renameFailed": "Failed to rename",
  "fileTree.toast.deleted.single": "Deleted \"{{name}}\"",
  "fileTree.toast.deleted.bulk": "Deleted {{count}} items",
  "fileTree.toast.deleted.hint": "Recoverable from system trash",
  "fileTree.toast.moved.single": "Moved 1 item",
  "fileTree.toast.moved.bulk": "Moved {{count}} items",
  "fileTree.toast.undo": "Undo",
  ...
  "fileTree.toast.copyRelPathSuccessSingle": "Relative path copied",
  "fileTree.toast.copyRelPathSuccessBulk": "{{count}} relative paths copied",
