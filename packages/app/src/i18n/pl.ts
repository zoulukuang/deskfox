export const dict = {
  ...
  "home.empty.title": "Twój osobisty asystent pracy AI jest gotowy",
  "home.empty.description": "Przekaż Foxowi swój lokalny folder projektu — dogłębnie zrozumie strukturę Twojego projektu i pomoże Ci w każdej chwili",
  "home.empty.open": "Otwórz folder projektu",
