export const dict = {
  ...
  "palette.group.sessionContent": "Zawartość sesji",
  "palette.sessionContent.searchAllProjects": "Szukaj we wszystkich projektach",
  "palette.sessionContent.searchCurrentProject": "Szukaj tylko w bieżącym projekcie",
  ...
  "home.welcome.title": "Twój osobisty asystent AI jest gotowy",
  "home.welcome.description": "Przekaż Foxowi swój lokalny folder projektu — dogłębnie zrozumie strukturę Twojego projektu i pomoże Ci w każdej chwili",
  "home.welcome.open": "Otwórz folder",
  ...
  "common.undo": "Cofnij",
  "find.placeholder": "Znajdź w sesji",
  "find.prev": "Poprzednie trafienie",
  "find.next": "Następne trafienie",
  "session.archive.toast.title": "Sesja zarchiwizowana",
  "session.archive.toast.description": "Znajdź ją w wyszukiwaniu, aby przywrócić",
  "common.delete": "Usuń",
