export const dict = {
  ...
  "palette.group.sessionContent": "Содержимое сессии",
  "palette.sessionContent.searchAllProjects": "Искать во всех проектах",
  "palette.sessionContent.searchCurrentProject": "Искать только в текущем проекте",
  ...
  "find.placeholder": "Найти в сессии",
  "find.prev": "Предыдущее совпадение",
  "find.next": "Следующее совпадение",
  "session.archive.toast.title": "Сессия архивирована",
  "session.archive.toast.description": "Найдите её через поиск, чтобы восстановить",
