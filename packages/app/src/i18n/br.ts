export const dict = {
  ...
  "home.empty.title": "Seu assistente de trabalho com IA pessoal está pronto",
  "home.empty.description": "Entregue sua pasta de projeto local ao Fox: ele entenderá profundamente a estrutura do seu projeto e ajudará você a qualquer momento",
  "home.empty.open": "Abrir pasta do projeto",
