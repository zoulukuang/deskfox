export const dict = {
  ...
  "palette.group.sessionContent": "Conteúdo da sessão",
  "palette.sessionContent.searchAllProjects": "Pesquisar em todos os projetos",
  "palette.sessionContent.searchCurrentProject": "Pesquisar apenas neste projeto",
  ...
  "home.welcome.title": "Seu assistente de IA pessoal está pronto",
  "home.welcome.description": "Entregue sua pasta de projeto local ao Fox: ele entenderá profundamente a estrutura do seu projeto e ajudará você a qualquer momento",
  "home.welcome.open": "Abrir pasta",
  ...
  "find.placeholder": "Localizar na sessão",
  "find.prev": "Ocorrência anterior",
  "find.next": "Próxima ocorrência",
  "session.archive.toast.title": "Sessão arquivada",
  "session.archive.toast.description": "Encontre-a na busca para restaurar",
