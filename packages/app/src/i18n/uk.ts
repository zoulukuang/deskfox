export const dict = {
  ...
  "find.placeholder": "Знайти в сесії",
  "find.prev": "Попередній збіг",
  "find.next": "Наступний збіг",
  "session.archive.toast.title": "Сесію заархівовано",
  "session.archive.toast.description": "Знайдіть її через пошук, щоб відновити",
  ...
  "session.invalidGroup.count.many": "{{count}} invalid call", // FORK-i18n-backfill(en 兜底)
