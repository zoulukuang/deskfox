export const dict = {
  ...
  "find.prev": "Prethodno podudaranje",
  "find.next": "Sljedeće podudaranje",
  "session.archive.toast.title": "Sesija arhivirana",
  "session.archive.toast.description": "Pronađite je pretragom da je vratite",
