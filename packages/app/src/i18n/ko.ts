export const dict = {
  ...
  "palette.group.sessionContent": "세션 내용",
  "palette.sessionContent.searchAllProjects": "모든 프로젝트에서 검색",
  "palette.sessionContent.searchCurrentProject": "현재 프로젝트만 검색",
  ...
  "error.page.report.prefix": "이 오류를 DeskFox 팀에 제보해 주세요: ",
  ...
  "home.welcome.title": "당신만의 AI 어시스턴트가 준비되었습니다",
  "home.welcome.description": "로컬 프로젝트 폴더를 Fox에 맡기면 프로젝트 구조를 깊이 이해하여 언제든지 도와드립니다",
  "home.welcome.open": "폴더 열기",
  ...
  "common.archive": "보관",
  "common.undo": "실행 취소",
  "find.placeholder": "세션 내 찾기",
  "find.prev": "이전",
  "find.next": "다음",
  "session.archive.toast.title": "보관됨",
  "session.archive.toast.description": "검색으로 찾아 복원할 수 있습니다",
  "common.delete": "삭제",
  "common.close": "닫기",
  "common.edit": "편집",
