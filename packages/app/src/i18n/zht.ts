...
export const dict = {
  ...
  // [feat: model-capability-ui] REQ-026 2026-08-02(徽標已撤,文案不再引用)
  "prompt.toast.imageUnsupported.title": "當前模型不支援圖片",
  "prompt.toast.imageUnsupported.description": "「{{model}}」不支援圖片輸入。請切換到支援圖片的視覺模型(懸停模型可查看輸入能力)後再貼上/拖入圖片。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 DeskFox 團隊",
  ...
  // FORK-BEGIN: home 空狀態歡迎文案對齊首次引導稿 2026-06-09
  "home.welcome.title": "你的專屬 AI 助理已就緒",
  "home.welcome.description": "將本地專案資料夾交給 Fox，它將深度理解你的專案結構，隨時為你提供協助",
  "home.welcome.open": "開啟資料夾",
  // FORK-END
  ...
  "common.archive": "封存",
  "common.undo": "復原",
  "find.placeholder": "在會話中尋找",
  "find.prev": "上一個",
  "find.next": "下一個",
  "session.archive.toast.title": "已封存",
  "session.archive.toast.description": "可在搜尋中找到並復原",
  "common.delete": "刪除",
  "common.close": "關閉",
  "common.edit": "編輯",
  ...
  "settings.general.row.shellToolPartsGrouped.title": "摺疊 Shell 命令",
  "settings.general.row.shellToolPartsGrouped.description": "把連續的 shell 命令收進一個可展開的分組,而不是逐條平鋪",
  "session.commandGroup.running": "正在執行命令",
  ...
  "settings.general.row.telemetry.locked": "(目前由 OPENCODE_TELEMETRY 環境變數或其他設定檔控制,此開關已停用。)",
  ...
  // FORK-BEGIN: 文件樹選單 i18n 2026-05-04
  "fileTree.menu.rename": "重新命名",
  "fileTree.menu.revealInFolder": "在資料夾中顯示",
  "fileTree.menu.copyPath": "複製檔案路徑",
  "fileTree.menu.cut": "剪下",
  "fileTree.menu.copy": "複製",
  "fileTree.menu.paste.toFolder": "貼上至此資料夾",
  "fileTree.menu.paste.toCurrentDir": "貼上至目前目錄",
  "fileTree.menu.paste.toRoot": "貼上至專案根目錄",
  "fileTree.menu.delete": "刪除",
  "fileTree.menu.newFile": "新增檔案",
  "fileTree.menu.newFolder": "新增資料夾",
  "fileTree.menu.refresh": "重新整理",
  "fileTree.menu.copyRelativePath": "複製相對路徑",
  "fileTree.menu.openInTerminal": "在終端機開啟",
  "fileTree.menu.expandAll": "全部展開",
  "fileTree.menu.collapseAll": "全部收合",
  ...
  "fileTree.dialog.newFolder.title": "新增資料夾",
  "fileTree.dialog.newFolder.label": "資料夾名稱",
  "fileTree.dialog.newFolder.placeholder": "新資料夾",
  "fileTree.dialog.rename.fileTitle": "重新命名檔案",
  "fileTree.dialog.rename.folderTitle": "重新命名資料夾",
  "fileTree.dialog.rename.label": "新名稱",
  "fileTree.dialog.rename.confirm": "重新命名",
  "fileTree.dialog.rename.unchanged": "名稱未變更",
  "fileTree.dialog.confirmDelete.fileTitle": "刪除檔案",
  "fileTree.dialog.confirmDelete.folderTitle": "刪除資料夾",
  "fileTree.dialog.confirmDelete.bulkTitle": "批次刪除",
  "fileTree.dialog.confirmDelete.messageSingle": "確定要刪除「{{name}}」嗎?",
  "fileTree.dialog.confirmDelete.messageBulk": "確定要刪除 {{name}} 嗎?",
  "fileTree.dialog.confirmDelete.bulkName": "{{count}} 個項目",
  "fileTree.dialog.confirmDelete.detail": "項目將移至系統資源回收筒,可從中還原。",
  "fileTree.dialog.confirmDelete.confirm": "刪除",
  "fileTree.dialog.create": "建立",
  "fileTree.dialog.cancel": "取消",
  "fileTree.dialog.validation.empty": "名稱不可為空",
  "fileTree.dialog.validation.invalidChar": "名稱不可包含 / 或 \\",
  "fileTree.dialog.validation.duplicate": "已存在同名檔案或資料夾",
  "fileTree.toast.operationFailed": "操作失敗",
  "fileTree.toast.openFailed": "開啟失敗",
  "fileTree.toast.deleteFailedSingle": "刪除失敗",
  "fileTree.toast.deleteFailedBulk": "{{count}} 項刪除失敗",
  "fileTree.toast.createFailed": "新建失敗",
  "fileTree.toast.renameFailed": "重新命名失敗",
  "fileTree.toast.deleted.single": "已刪除「{{name}}」",
  "fileTree.toast.deleted.bulk": "已刪除 {{count}} 項",
  "fileTree.toast.deleted.hint": "可在系統資源回收筒復原",
  "fileTree.toast.moved.single": "已移動 1 項",
  "fileTree.toast.moved.bulk": "已移動 {{count}} 項",
  "fileTree.toast.undo": "復原",
  "fileTree.toast.moveFailedSingle": "移動失敗",
  "fileTree.toast.moveFailedBulk": "{{count}} 項移動失敗",
  "fileTree.toast.copyFailedSingle": "複製失敗",
  "fileTree.toast.copyFailedBulk": "{{count}} 項複製失敗",
  "fileTree.toast.pasteFailedSingle": "貼上失敗",
  "fileTree.toast.pasteFailedBulk": "{{count}} 項貼上失敗",
  "fileTree.toast.undoFailedPartial": "復原失敗(部分)",
  "fileTree.toast.copyPathSuccessSingle": "已複製路徑",
  "fileTree.toast.copyPathSuccessBulk": "已複製 {{count}} 個路徑",
  "fileTree.toast.copyRelPathSuccessSingle": "已複製相對路徑",
  "fileTree.toast.copyRelPathSuccessBulk": "已複製 {{count}} 個相對路徑",
  ...
  "settings.feishu.noDefaultModel.hint": "可以照常綁定 Lark 帳號,但收到 Lark 訊息時若沒有預設 model,DeskFox 無法回覆。請到 Settings → Providers 設定一個 provider 的 API key,build agent 的預設 model 會自動完成。",
  "settings.feishu.account.empty.title": "尚未綁定 Lark 帳號",
  "settings.feishu.account.empty.description": "綁定你的第一個 Lark / 飛書 帳號即可開始接收訊息。",
  "settings.feishu.account.add": "新增 Lark 帳號",
  "settings.feishu.account.delete": "刪除",
  "settings.feishu.bind.title": "綁定 Lark 帳號",
  "settings.feishu.bind.domain.label": "選擇網域",
  "settings.feishu.bind.domain.feishu": "飛書(國內)",
  "settings.feishu.bind.domain.lark": "Lark(國際)",
  "settings.feishu.bind.scanQr": "用 Lark App 掃描下方 QR Code 完成授權",
  "settings.feishu.bind.userCodeLabel": "或在 Lark App 中輸入此 user_code",
  "settings.feishu.bind.expiresIn": "{{secs}} 秒後過期",
  "settings.feishu.bind.statusPending": "等待使用者授權...",
  "settings.feishu.bind.statusSuccess": "已成功綁定",
  "settings.feishu.bind.statusDenied": "使用者拒絕授權",
  "settings.feishu.bind.statusExpired": "QR Code 已過期",
  ...
  "settings.feishu.edit.autoFreeModel": "自動(始終用免費模型)",
  "settings.feishu.edit.autoFreeModel.hint":
    "始終使用 OpenCode Zen 當下第一個免費模型 —— 即使日後模型更換也能繼續用,無需設定或登入。",
  "settings.feishu.edit.providerPlaceholder": "請選擇提供商",
  "settings.feishu.edit.modelPlaceholder": "請選擇模型",
  ...
  "settings.feishu.edit.workspace.defaultPath": "預設目錄:{{path}}",
