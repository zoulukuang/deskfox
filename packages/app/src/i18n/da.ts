export const dict = {
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til DeskFox-teamet",
  ...
  "common.undo": "Fortryd",
  "find.placeholder": "Find i session",
  "find.prev": "Forrige match",
  "find.next": "Næste match",
  "session.archive.toast.title": "Session arkiveret",
  "session.archive.toast.description": "Find den via søgning for at gendanne",
  "common.delete": "Slet",
  "common.close": "Luk",
  "common.edit": "Rediger",
