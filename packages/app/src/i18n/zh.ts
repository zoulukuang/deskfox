...
export const dict = {
  ...
  // FORK 2026-09-19:队列路径专属标题 —— 通用 title 说"已放回输入框",这条路径不回输入框
  "prompt.toast.promptNotDelivered.queued.title": "这条可能没发出去,仍留在队列里",
  "prompt.toast.promptNotDelivered.queued.description":
    "后台引擎 2 分钟内没有响应。这条仍在队列里、已标记为失败,可以重发 —— 重发前请先看一眼对话里是否已经有了。",
