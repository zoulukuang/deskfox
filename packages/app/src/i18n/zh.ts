...
export const dict = {
  ...
  "settings.general.row.shellToolPartsGrouped.title": "折叠 Shell 命令",
  "settings.general.row.shellToolPartsGrouped.description": "把连续的 shell 命令收进一个可展开的分组,而不是逐条平铺",
  "session.commandGroup.running": "正在运行命令",
