export const dict = {
  ...
  "palette.group.sessionContent": "เนื้อหาเซสชัน",
  "palette.sessionContent.searchAllProjects": "ค้นหาในทุกโปรเจกต์",
  "palette.sessionContent.searchCurrentProject": "ค้นหาเฉพาะโปรเจกต์นี้",
  ...
  "common.undo": "เลิกทำ",
  "find.placeholder": "ค้นหาในเซสชัน",
  "find.prev": "ก่อนหน้า",
  "find.next": "ถัดไป",
  "session.archive.toast.title": "เก็บถาวรแล้ว",
  "session.archive.toast.description": "ค้นหาเพื่อกู้คืนได้",
  "common.delete": "ลบ",
  "common.close": "ปิด",
  "common.edit": "แก้ไข",
