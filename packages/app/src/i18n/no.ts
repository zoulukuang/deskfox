...
export const dict = {
  ...
  "palette.group.sessionContent": "Sesjonsinnhold",
  "palette.sessionContent.searchAllProjects": "Søk i alle prosjekter",
  "palette.sessionContent.searchCurrentProject": "Søk kun i dette prosjektet",
  ...
  "common.undo": "Angre",
  "find.placeholder": "Finn i økt",
  "find.prev": "Forrige treff",
  "find.next": "Neste treff",
  "session.archive.toast.title": "Økt arkivert",
  "session.archive.toast.description": "Finn den via søk for å gjenopprette",
  "common.delete": "Slett",
  "common.close": "Lukk",
  "common.edit": "Rediger",
