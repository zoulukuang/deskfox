export const dict = {
  ...
  "palette.group.sessionContent": "محتوى الجلسة",
  "palette.sessionContent.searchAllProjects": "البحث في جميع المشاريع",
  "palette.sessionContent.searchCurrentProject": "البحث في هذا المشروع فقط",
  ...
  "home.welcome.title": "مساعدك الذكي الخاص بك جاهز",
  "home.welcome.description": "سلّم مجلد مشروعك المحلي إلى Fox، وسيفهم بنية مشروعك بعمق ويساعدك في أي وقت",
  "home.welcome.open": "افتح المجلد",
  ...
  "common.undo": "تراجع",
  "find.placeholder": "بحث في الجلسة",
  "find.prev": "التطابق السابق",
  "find.next": "التطابق التالي",
  "session.archive.toast.title": "تمت أرشفة الجلسة",
  "session.archive.toast.description": "ابحث عنها لاستعادتها",
  "common.delete": "حذف",
  "common.close": "إغلاق",
  "common.edit": "تحرير",
