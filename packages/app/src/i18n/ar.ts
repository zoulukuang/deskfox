export const dict = {
  ...
  "home.empty.title": "مساعد العمل الذكي الخاص بك جاهز",
  "home.empty.description": "سلّم مجلد مشروعك المحلي إلى Fox، وسيفهم بنية مشروعك بعمق ويساعدك في أي وقت",
  "home.empty.open": "افتح مجلد المشروع",
