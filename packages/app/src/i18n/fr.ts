export const dict = {
  ...
  "home.empty.title": "Votre assistant de travail IA personnel est prêt",
  "home.empty.description": "Confiez votre dossier de projet local à Fox : il comprendra en profondeur la structure de votre projet et vous aidera à tout moment",
  "home.empty.open": "Ouvrir le dossier du projet",
