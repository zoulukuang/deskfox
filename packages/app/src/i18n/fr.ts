export const dict = {
  ...
  "palette.group.sessionContent": "Contenu de la session",
  "palette.sessionContent.searchAllProjects": "Rechercher dans tous les projets",
  "palette.sessionContent.searchCurrentProject": "Rechercher uniquement dans ce projet",
  ...
  "common.undo": "Annuler",
  "find.placeholder": "Rechercher dans la session",
  "find.prev": "Occurrence précédente",
  "find.next": "Occurrence suivante",
  "session.archive.toast.title": "Session archivée",
  "session.archive.toast.description": "Retrouvez-la via la recherche pour la restaurer",
