...
export const dict = {
  ...
  "palette.group.sessionContent": "Sitzungsinhalt",
  "palette.sessionContent.searchAllProjects": "In allen Projekten suchen",
  "palette.sessionContent.searchCurrentProject": "Nur im aktuellen Projekt suchen",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem DeskFox-Team",
  ...
  "home.welcome.title": "Ihr persönlicher KI-Assistent ist bereit",
  "home.welcome.description": "Übergeben Sie Ihren lokalen Projektordner an Fox – es versteht Ihre Projektstruktur tiefgreifend und hilft Ihnen jederzeit",
  "home.welcome.open": "Ordner öffnen",
  ...
  "find.placeholder": "In Sitzung suchen",
  "find.prev": "Vorheriger Treffer",
  "find.next": "Nächster Treffer",
  "session.archive.toast.title": "Sitzung archiviert",
  "session.archive.toast.description": "Über die Suche wiederherstellbar",
