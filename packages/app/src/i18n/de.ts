...
export const dict = {
  ...
  "home.empty.title": "Ihr persönlicher KI-Arbeitsassistent ist bereit",
  "home.empty.description": "Übergeben Sie Ihren lokalen Projektordner an Fox – es versteht Ihre Projektstruktur tiefgreifend und hilft Ihnen jederzeit",
  "home.empty.open": "Projektordner öffnen",
