export const dict = {
  ...
  "ui.messagePart.context.command.zero": "{{count}} commands", // FORK-i18n-backfill(en 兜底)
  "ui.messagePart.context.command.two": "{{count}} commands", // FORK-i18n-backfill(en 兜底)
  "ui.messagePart.context.command.few": "{{count}} commands", // FORK-i18n-backfill(en 兜底)
