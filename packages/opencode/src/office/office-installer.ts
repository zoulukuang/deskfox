...
// FORK: 跟上游 Global 迁到 @opencode-ai/core 走;Process 留 opencode 内部 2026-05-03
import { Global } from "@opencode-ai/core/global"
// FORK: 上游 #31310 删 core/util/log 的 Log.create API → 本地 console shim [feat: electron-replatform]
...
async function downloadWithProgress(
  ...
  // FORK: Bun.file().writer() → Node fs.createWriteStream(Electron sidecar 跑 Node 无 Bun) [feat: electron-replatform]
  ...
  // FORK: Node WriteStream 收尾(无 flush;end + 等 finish/error)[feat: electron-replatform]
