...
- [x] 全新机器双击启动:`Documents/New DeskFox/` 已创建 ✅ + 作为工作区自动打开 ✅ + `关于 DeskFox 你该知道的几件事.md` **自动作首个 tab 激活渲染 ✅**(2026-07-14 修复 review 默认 active 覆盖后,Mac CDP 隔离首启复验 2s 内 active=介绍文档 + 全文 + 二维码 naturalWidth 1372×1392);视觉最终确认建议 user 双击真机看
