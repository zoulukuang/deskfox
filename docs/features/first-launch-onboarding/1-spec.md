...
- [ ] 全新机器双击启动:`Documents/New DeskFox/` 已创建并作为工作区自动打开,`关于 DeskFox 你该知道的几件事.md` 作首个 tab 显示,文末官方群二维码正常渲染 —— **待真桌面 QA**
- [ ] macOS 与 Windows 均落在各自系统 Documents(`app.getPath("documents")`),文件夹里只有那一个文件 —— **待真桌面 QA(Win)**
